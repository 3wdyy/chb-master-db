...
// ============================================================================
// PATTERN 2.5: DYNAMIC DIMENSION EXTRACTION (CRITICAL)
// ============================================================================

// ✅ CORRECT: Extract dimension values from data at runtime
...
function getMarkets(data) {
    return getUniqueDimensionValues(data, 'Market');
}

// Get brands from data (for P2)
function getBrands(data) {
    return getUniqueDimensionValues(data, 'Brand');
}

// Get channels from data (for P2)
function getChannels(data) {
    return getUniqueDimensionValues(data, 'Channel');
}

// ❌ WRONG: Never hardcode dimension values
// const MARKETS = ['All Markets', 'UAE', 'KSA', ...];
// const BRANDS = ['Level Shoes', 'Faces', ...];
