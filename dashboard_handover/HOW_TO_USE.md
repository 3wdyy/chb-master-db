...
1. Read CLAUDE.md first (this sets your behavior)
2. Read all files in the specs/ folder
3. Read the patterns/ folder for code reference
4. Output your implementation plan for Phase 1 BEFORE writing any code
5. Ask any clarifying questions before proceeding

The goal is to extend the existing Dashboard.html with a C-Overview mode for executives.
```
...
Say: "Stop. Please output your implementation plan before writing any code. Read 01_SYSTEM_PROMPT.md again."
